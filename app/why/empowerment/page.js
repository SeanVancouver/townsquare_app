  ...
  return (
    <>
      ...
      <div>
        ...
        <p><br /></p>
        <p>It offers you the power to instantly reach the entire population of your city. Instead of interacting on the usual person to person basis, you can now broadcast to the entire city, and hear the city echo back to you. When yield properly, it can make your whatever dream of yours come true.</p>
        <p><br /></p>
        <p>Just imagine the leverage this gives you. This is having an equivalent reach of a top tier influencer or Youtuber who have millions of followers/subscribers, except that you never have to work for it. Whether you have an idea to spread or a project to create, you can now find like minded people city wide at the click of a button. Here are just three examples of usage.</p>
        <p><br /></p>
        <p>1. Seeking</p>
        ...
        <p><br /></p>
        <p>&nbsp; &nbsp; But with TownSquare, you can now filter the entire city&apos;s population, for other Hello Kitty loving bikers. Then you get a map of people matching the criteria. There may not be many, but at least now you can find your niche tribe.</p>
        <p><br /></p>
        <p><br /></p>
        <p>2. Browsing</p>
        ...
        <p><br /></p>
        <p><br /></p>
        <p>The possibilities are endless. And it is all possible because TownSquare limits the service area to that of a city. Because we don&apos;t have to think about scaling geographically, we can implement as much features as we desire, whether it is allowing money transfer between users, or API integration with other platforms. Sky is the limit.</p>
        <p><br /></p>
        <p>This unprecedented power was previously only held by the big data companies, but now it is in the palm of your hand. Of course everyone else will share this power, but this is what brings back the community and make our cities fun and alive again.</p>
      </div>
