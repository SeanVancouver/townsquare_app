  ...
  return (
    <>
      <article className="leading-6 m-0 px-8 py-8 sm:text-[1.2rem]">
        ...
        <p>So how do the dicators of the East compare with the elites of the West? Having lived in both East and West, I can say that the Western elites operates at a higher level with more succinct.</p>
        ...
        <p>&nbsp; &nbsp; &nbsp; &nbsp; - And the &quot;How to save yourself and your loved ones&quot; kind.</p>
        ...
        <p>And this is how we can push back the elites, brick by brick. Every little empowerment for the people chips away their power, and opens the door for more empowerment.</p>

        <div className='flex justify-between flex-col sm:flex-row'>
          <p className='mb-0'>Previous reason: <Link href="/why/capitalism">&lt;&nbsp;Capitalism</Link></p>
          <p className='mb-0'>Next reason: <Link href="/why/people">People&nbsp;&#62;</Link></p>
        </div>
