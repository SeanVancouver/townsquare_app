  ...
  return (
    <>
      <div>
        ...
        <p><br /></p>
        <p>When people socialize in real life, they use a more natural approach. They would get to know the person first, then decide which of his needs can be satisfied from here. There is no restriction on the purpose as it is the case with online platforms. You could be talking to someone who can satisfy all your needs, by becoming your boss, your romantic partner and fishing buddy at the same time.</p>
        <p><br /></p>
        ...
        <p><br /></p>
        <p>This works because it offers the prerequisite to mimick real and efficient human interaction. Instead of limiting the purpose of its users, TownSquare is purpose agnostic. The app is only responsible to make its users visible to others, while the users themselves determine what they want to do with the app. You can indicate, for example, that you are looking for relationship, open for employment, and want to form a rock band at the same time.</p>
        <p><br /></p>
        <p>How can someone find you based on your profile? This is where the magic happens; another user would be able to narrow down the population using their own customizable criteria. For example, someone with guitar skill between the age of 20 to 25. Then they would select your profile, and checkout the video you have uploaded shredding your guitar, and finally message you to join their band.&nbsp;</p>
        <p><br /></p>
        <p>The idea is to create an open world system where everyone and every post is visible. This is unprecedently empowering because you, as an individual, now have the power to interact with the community directly without prerequisite or limitation.&nbsp;</p>
        <p><br /></p>
      </div>
